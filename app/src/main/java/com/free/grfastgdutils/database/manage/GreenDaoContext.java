...
import com.free.grfastgdutils.MyApplication;
import com.free.grfastgdutils.database.DaoFilePahtUtils;
 ...
 * 描述：继承application，初始化数据库
 * 最近修改时间：2017/5/15
 */

/**
 * 指定数据库文件生成目录,主要用于基于GreenDao框架自定义数据库路径
 */
public class GreenDaoContext extends ContextWrapper {

    private String currentUserId = "SqlDatabase";//一般用来针对一个用户一个数据库，以免数据混乱问题
    ...
    public File getDatabasePath(String dbName) {
        String dbDir = DaoFilePahtUtils.getDBPath();
